...
declare -A KEYBINDS=(
  ...
  ["SUPER + D            │ Open VSCodium"]="hyprctl dispatch exec codium"
  ...
  ["SUPER + CTRL + R     │ Reload Hyprland Config"]="hyprctl reload && notify-send \"hyprland\" \"configuration reloaded\""
  ...
  ["SUPER + ALT + P      │ Perplexity AI Web App"]="hyprctl dispatch exec \"brave --app=https://www.perplexity.ai\""
  ["SUPER + ALT + C      │ ChatGPT Web App"]="hyprctl dispatch exec \"brave --app=https://chatgpt.com\""
  ["SUPER + ALT + A      │ Claude AI Web App"]="hyprctl dispatch exec \"brave --app=https://claude.ai\""
  ...
  ["Print                │ Screenshot Region (Save File)"]="hyprctl dispatch exec \"grim -g \\\"\$(slurp)\\\" ~/Pictures/Screenshots/\$(date +'%Y-%m-%d_%H-%M-%S').png && dunstify \\\"Screenshot\\\" \\\"Screenshot saved!\\\" -a \\\"grim\\\" -t 3000\""
  ["SUPER + SHIFT + S    │ Screenshot Region (To Clipboard)"]="hyprctl dispatch exec \"grim -g \\\"\$(slurp)\\\" - | wl-copy\""
  ["SUPER + CTRL + S     │ Fullscreen Screenshot (Save File)"]="hyprctl dispatch exec \"grim ~/Pictures/Screenshots/\$(date +'%Y-%m-%d_%H-%M-%S').png && dunstify \\\"Screenshot\\\" \\\"Screenshot saved!\\\" -a \\\"grim\\\" -t 3000\""
